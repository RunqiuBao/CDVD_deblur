...
class Parameter:
    ...
    def extract_args(self):
        ...
        # global parameters
        self.parser.add_argument('--epsilon', type=float, default=1e-6, help='computation epsilon')
        ...
        self.parser.add_argument('--profile_H', type=int, default=180,
        ...
        # data parameters
        self.parser.add_argument('--lib_dir', type=str, default='./libs/', help='the path to libs')
        ...
        self.parser.add_argument('--patch_size', type=int, nargs='*', default=[30, 30])

        # model parameters
        self.parser.add_argument('--model', type=str, default='Event_ESTRNN', help='type of model to construct')
        ...
        self.parser.add_argument('--no_batch_norm', action='store_true', help='If true, batch norm will not be performed at each layer', default=False)
        self.parser.add_argument('--n_blocks_a', type=int, default=4, help='# of blocks in middle part of the model')
        self.parser.add_argument('--n_blocks_b', type=int, default=5, help='# of blocks in middle part of the model')
        self.parser.add_argument('--n_blocks_igp', type=int, default=3, help='# of blocks in middle part of the model')
        ...
        self.parser.add_argument('--lr', type=float, default=4e-4, help='learning rate')
        self.parser.add_argument('--lr_decay', type=int, default=200, help='learning rate decay per N epochs')
        self.parser.add_argument('--lr_gamma', type=float, default=0.5, help='learning rate decay factor for step decay')
        self.parser.add_argument('--lr_min', type=float, default=1e-8, help='learning rate')
        ...
        self.parser.add_argument('--test_arrow_flow', action='store_true', help='draw arrows for result optical flow in test')
        
        self.parser.add_argument('--data_form', type=str, help='choose correct dataloader form')
